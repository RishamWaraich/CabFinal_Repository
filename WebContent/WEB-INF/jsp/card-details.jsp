			...
			<div class="col-md-12 blog-area">				
				...
				<form:form action="authentication" method = "POST" > <!-- modelAttribute="user" > -->
					...
					<div class="form-group col-md-12 col-sm-12 col-xs-12">
						...
						<input type="text" class="form-control" pattern="[0-9]{13,16}" placeholder="e.g  1234458678591  13-16 Digits" />						 

					</div>
					<div class="form-group col-md-8 col-sm-12 col-xs-12">
						<label>Expiry (MM/YY)<span style="color:red" >*</span></label>
						<input type="text" class="form-control" pattern="^(0[1-9]|1[0-2]|[1-9])\/(1[4-9]|[2-9][0-9]|20[1-9][1-9])$"  placeholder="01/19"/>
					</div>	
					<div class="form-group col-md-4 col-sm-12 col-xs-12">
						<label>Card Code<span style="color:red" >*</span></label>
						<input type="text" class="form-control" pattern="[0-9][0-9][0-9]" placeholder="123" />
					</div>
