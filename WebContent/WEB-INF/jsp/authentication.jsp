	...
	<div id="page-banner" class="page-banner blog-banner container-fluid no-padding">
		<div class="page-heading">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><a href="#">Authentication</a></li>
			</ol>
		</div>
	</div><!-- Banner Section /- -->
	...
	<div class="container-fluid no-padding page-content book-taxi-online-form">
		...
		<div class="container">		
			...
			<div class="col-md-12 blog-area">				
				...
				<!-- Online Booking Form -->
				<form:form action="dashboard1" method = "POST"  class="online-booking-form row">
					<h4>Secure Authentication</h4>					
					
					<div class="form-group col-md-4 col-sm-12 col-xs-12">
						<label>Your One-Time Passcode (OTP):</label>
						<input type="number" name="oneTimeCode" pattern="[0-9][0-9][0-9][0-9]" class="form-control" />
					</div>
						
					<div class="form-group col-md-6 col-sm-12 col-xs-12">
						<input type="submit" class="btn" value="Validate" />
					</div>
					<div>	<c:if test="${not empty errorMesage}">
